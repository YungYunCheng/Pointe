...
.op-tabs button.on{color:var(--ink);border-bottom-color:var(--brand,var(--ink))}
...
.op-btn{font:inherit;font-weight:600;font-size:13px;cursor:pointer;background:var(--brand,var(--ink));color:#fff;
