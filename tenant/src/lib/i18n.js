...
const D = {
  en: {
    ...
    "home.leadAvailable": "{n} suites are available now, starting from {rent} per month.",
    "home.availableTitle": "Currently available",
    "home.seeAll": "See all suites",
    "home.locationTitle": "Connected to the city",
    "home.locTransit.v": "2 min", "home.locTransit.l": "Walk to Clareview LRT",
    "home.locDowntown.v": "22 min", "home.locDowntown.l": "Train to downtown",
    "home.locShops.v": "5 min", "home.locShops.l": "Walk to shopping",
    "home.locSchools.v": "1 train", "home.locSchools.l": "NAIT, MacEwan and U of A",
    "home.bandTitle": "Come see Baydo Pointe",
    "home.bandBody": "Tour an available suite and see how close everyday life can be.",
    ...
    "portal.signInSub": "For tenants who have moved in. Use the email on your lease.",
    "portal.email": "Email", "portal.password": "Password", "portal.signIn": "Sign in",
    "portal.forgot": "Forgot your password?",
    "portal.firstTime": "First time? Set up your account",
    ...
    "portal.tabRent": "Rent", "portal.tabDocs": "Documents", "portal.tabMoving": "Moving elevator",
    ...
    "moving.title": "Move-in / move-out elevator",
    "moving.sub": "Request a moving time. The Building Manager confirms it before the elevator is reserved.",
    "moving.new": "Request a time", "moving.none": "No moving elevator requests yet.",
    "moving.direction": "Moving", "moving.moveIn": "Move in", "moving.moveOut": "Move out",
    "moving.date": "Date", "moving.from": "From", "moving.to": "To",
    "moving.notes": "Notes for the Building Manager", "moving.submit": "Send request",
    "moving.cancel": "Cancel request", "moving.slotTaken": "That elevator time is already requested. Please choose another time.",
    "moving.status.requested": "Waiting for BM", "moving.status.confirmed": "Confirmed",
    "moving.status.declined": "Choose another time", "moving.status.cancelled": "Cancelled",
    "moving.status.completed": "Completed",
    ...
    "common.close": "Close", "common.cancel": "Cancel", "common.yes": "Yes", "common.no": "No",
    "common.contact": "Contact us", "common.privacy": "Privacy",
    "common.office": "Office", "common.emergency": "Emergency",
    "footer.tagline": "Connected rental living beside Clareview LRT.",
    "footer.navigation": "Navigation", "footer.staffLogin": "Staff login",
    "footer.contact": "Contact us", "footer.hours": "Monday–Friday · 9:00 AM–5:00 PM",
    "footer.residents": "Residents", "footer.portalLink": "Tenant portal",
    "footer.repairLink": "Submit a repair request", "footer.rights": "All rights reserved.",
  ...
  zh: {
    ...
    "home.cta": "看看有哪些空房",
    "home.leadAvailable": "目前有 {n} 套空房，每月租金由 {rent} 起。",
    "home.availableTitle": "目前可租",
    "home.seeAll": "查看全部房型",
    "home.locationTitle": "交通與生活",
    "home.locTransit.v": "2 分鐘", "home.locTransit.l": "步行至 Clareview 輕軌站",
    "home.locDowntown.v": "22 分鐘", "home.locDowntown.l": "搭乘輕軌至市中心",
    "home.locShops.v": "5 分鐘", "home.locShops.l": "步行至購物區",
    "home.locSchools.v": "一條線", "home.locSchools.l": "前往 NAIT、MacEwan 與 U of A",
    "home.bandTitle": "親自看看 Baydo Pointe",
    "home.bandBody": "預約參觀目前可租的房型，感受便利的生活環境。",
    "home.ctaSecond": "預約看房",
    ...
    "portal.title": "住戶專區",
    "portal.signInSub": "已入住的租客使用，請用租約上的 Email。",
    "portal.email": "Email", "portal.password": "密碼", "portal.signIn": "登入",
    "portal.forgot": "忘記密碼？",
    "portal.firstTime": "第一次使用？設定帳戶",
    ...
    "portal.tabRent": "租金", "portal.tabDocs": "文件", "portal.tabMoving": "搬家電梯",
    ...
    "moving.title": "入住／搬出電梯預約",
    "moving.sub": "選擇搬家時間，Building Manager 確認後才算正式保留電梯。",
    "moving.new": "申請時段", "moving.none": "目前沒有搬家電梯申請。",
    "moving.direction": "類型", "moving.moveIn": "入住", "moving.moveOut": "搬出",
    "moving.date": "日期", "moving.from": "開始時間", "moving.to": "結束時間",
    "moving.notes": "給 Building Manager 的備註", "moving.submit": "送出申請",
    "moving.cancel": "取消申請", "moving.slotTaken": "這個電梯時段已有人申請，請選其他時間。",
    "moving.status.requested": "等待 BM 確認", "moving.status.confirmed": "已確認",
    "moving.status.declined": "請改選時間", "moving.status.cancelled": "已取消",
    "moving.status.completed": "已完成",
    ...
    "common.close": "關閉", "common.cancel": "取消", "common.yes": "是", "common.no": "否",
    "common.contact": "聯絡我們", "common.privacy": "隱私權",
    "common.office": "辦公室", "common.emergency": "緊急聯絡",
    "footer.tagline": "位於 Clareview 輕軌站旁的便利租住社區。",
    "footer.navigation": "網站導覽", "footer.staffLogin": "員工登入",
    "footer.contact": "聯絡我們", "footer.hours": "星期一至五 · 上午 9:00–下午 5:00",
    "footer.residents": "住戶服務", "footer.portalLink": "住戶專區",
    "footer.repairLink": "提交維修申請", "footer.rights": "保留所有權利。",
