...
-- ═══════════════════════════════════════════════════════════════════════
--
--   1. Sign in as admin@themizar.ca with the password in 005_admin.sql
--      and change it. That password is in a file, in a repository, and in
--      a chat log — treat it as known to everybody.
--
