...
import { detectMode } from "./lib/store.js";
...
const ClaimAccount    = lazy(() => import("./tools/ClaimAccount.jsx"));
const InviteStaff     = lazy(() => import("./tools/InviteStaff.jsx"));
...
const TOOLS = [
  ...
  { path: "/invite",      label: "Invite",      el: InviteStaff,     roles: ["admin"] },
];
...
.sh-source{font-size:10.5px;font-weight:700;color:#6B5410;background:#FFF6E0;
  border:1px solid #E8C877;border-radius:9px;padding:2px 9px;margin-right:9px;
  letter-spacing:.01em}
