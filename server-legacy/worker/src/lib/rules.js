...
/** Notice before a rent increase takes effect, on a periodic tenancy.
 *  A fixed term cannot be increased mid-term at all. */
export const INCREASE_NOTICE_DAYS = 90;

/** Notice to end a tenancy. Different by term type. */
export const END_NOTICE_DAYS = { fixed: 60, periodic: 90 };
