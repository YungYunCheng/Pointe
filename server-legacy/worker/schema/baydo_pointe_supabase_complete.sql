...
-- Legacy reference only. The bootstrap user has no password and must use the
-- one-time Forgot password flow before the first sign-in.
UPDATE users
...
-- After the one-time reset, invite other staff from Admin → Accounts.
...
-- ═══════════════════════════════════════════════════════════════════════
--
--   1. Use Forgot password for admin@themizar.ca. No reusable bootstrap
--      password is stored in the schema or repository.
--
